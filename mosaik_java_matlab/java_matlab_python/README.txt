...
Il fatto che sia stato così semplice è un ottimo segno, perchè significa che sono davvero riuscito ad aggiustare le varie
API in modo che tutto funzioni correttamente. Il vantaggio della piattaforma mosaik è che tutti i dati passano attraverso
